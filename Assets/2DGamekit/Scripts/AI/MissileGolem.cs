...
#endif
{
    ...
    void ActivateShield()
    {
        audioBossManager.BossShieldUp(gameObject);
    ...
    void ActivateLightning()
    {
        ...
        audioBossManager.BossLightningAttack(p);
    ...
    void NextRound()
    {
        ...
        if (round == 2)
        {
            ...
            roundDeathSource.Play();
            */
            audioBossManager.BossSteamStage1(gameObject);
        }
        else if (round == 3)
        {
            ...
            roundDeathSource.Play();
            */
            audioBossManager.BossSteamStage2(gameObject);
        }
    }
    ...
    {
        audioBossManager.BossShieldDown(gameObject);
